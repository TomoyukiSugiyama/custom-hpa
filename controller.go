...
type Controller struct {
	...
	foosLister        listers.CustomHPALister
...
func (c *Controller) updateFooStatus(foo *samplev1alpha1.CustomHPA, deployment *appsv1.Deployment) error {
	...
	_, err := c.sampleclientset.CustomhpacontrollerV1alpha1().CustomHPAs(foo.Namespace).UpdateStatus(context.TODO(), fooCopy, metav1.UpdateOptions{})
	return err
}
